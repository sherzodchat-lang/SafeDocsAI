...
# кластеров их не представить.
#
# Верхняя выросла до 64, когда рубрик стало 29. При потолке в 32 силуэт упирался
# в край сетки и продолжал расти — то есть выбор k делала не структура данных, а
# длина списка, который я написал. Кластеров нужно ЗАМЕТНО больше, чем классов:
# рубрика законно распадается на части («Экономика» — на бюджет, банки и
# внешнюю торговлю), и запретить ей это значит слить их с чужими.
K_GRID = (12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 56, 64)
