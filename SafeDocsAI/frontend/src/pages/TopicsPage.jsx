...
// Раскрытие карточки модели запоминаем: тому, кто смотрит метрики каждый день,
// иначе открывать их пришлось бы при каждом заходе.
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        {/* Пустые темы — под раскрытием, тем же приёмом, что карточка
                            «О модели» ниже. Папками они НЕ делаются: раскрывать в них
                            нечего, а переход в список источников по пустой теме ведёт
                            на пустой экран. */}
